...
public class Receipt {
    ...
    public double CalculateGrandTotal(List<Product> products, List<OrderItem> items) {
        ...
        subTotal = calculateDiscountTotal(products, items, subTotal);
    ...
    private BigDecimal calculateDiscountTotal(List<Product> products, List<OrderItem> items, BigDecimal subTotal) {
